...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushRock.setGeometry(QtCore.QRect(130, 320, 91, 91))
        self.pushRock.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("rock.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushRock.setIcon(icon)
        ...
        self.pushPaper.setGeometry(QtCore.QRect(260, 320, 91, 91))
        self.pushPaper.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Paper.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushPaper.setIcon(icon1)
        ...
        self.pushScissors.setGeometry(QtCore.QRect(390, 320, 91, 91))
        self.pushScissors.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("scissors.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.pushScissors.setIcon(icon2)
        ...
        self.labelOption.setGeometry(QtCore.QRect(150, 280, 311, 41))
        font = QtGui.QFont()
        ...
        self.labelResults.setGeometry(QtCore.QRect(10, 250, 581, 41))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(85, 170, 127))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        self.labelPChoice.setGeometry(QtCore.QRect(130, 130, 121, 111))
        font = QtGui.QFont()
        ...
        self.labelCChoice.setGeometry(QtCore.QRect(370, 130, 121, 111))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.labelPscore = QtWidgets.QLabel(self.centralwidget)
        self.labelPscore.setGeometry(QtCore.QRect(20, 110, 51, 51))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.labelPscore.setFont(font)
        self.labelPscore.setAlignment(QtCore.Qt.AlignCenter)
        self.labelPscore.setObjectName("labelPscore")
        self.labelCscore = QtWidgets.QLabel(self.centralwidget)
        self.labelCscore.setGeometry(QtCore.QRect(530, 110, 51, 51))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.labelCscore.setFont(font)
        self.labelCscore.setAlignment(QtCore.Qt.AlignCenter)
        self.labelCscore.setObjectName("labelCscore")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelPscore.setText(_translate("MainWindow", "0"))
        self.labelCscore.setText(_translate("MainWindow", "0"))
